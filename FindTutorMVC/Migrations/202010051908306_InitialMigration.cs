namespace FindTutorMVC.Migrations
{
    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.FavouriteAnnouncementToUsers",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Reviews", "Submitter_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.Reviews", "Announcement_Id", "dbo.Announcements");
            DropForeignKey("dbo.Announcements", "Tutor_Id", "dbo.AspNetUsers");
            ...
            DropTable("dbo.FavouriteAnnouncementToUsers");
